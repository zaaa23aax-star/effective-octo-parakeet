...
st.set_page_config(page_title="🛍️ Amazon Finder (Pinterest Style)", layout="wide")
st.title("🛍️ Amazon Product Finder - Pinterest Style")
...
# -----------------------------
st.markdown("---")
if st.button("🔍 Search One Product"):
